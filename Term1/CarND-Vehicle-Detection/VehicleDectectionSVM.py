...
############################### Ectract Features ###############################
def get_hog_features(rgb_image, color_space='YCrCb', hog_channel='ALL', 
...
def test_hog_feature():
    ...
    car_features, car_hog_images = get_hog_features(car_rgb_image, color_space='HLS', hog_channel='ALL', vis=True, feature_vec=True)
    no_car_features, no_car_hog_images = get_hog_features(no_car_rgb_image, color_space='HLS', hog_channel='ALL', vis=True, feature_vec=True)
...
def extract_features(rgb_image):
    ...
    hog_features_1 = get_hog_features(rgb_image, color_space='YCrCb', hog_channel='CH_FIRST', vis=False, feature_vec=True)
    hog_features_2 = get_hog_features(rgb_image, color_space='YCrCb', hog_channel='CH_SECOND', vis=False, feature_vec=True)
    hog_features_3 = get_hog_features(rgb_image, color_space='YCrCb', hog_channel='CH_THIRD', vis=False, feature_vec=True)
...
def generate_serach_windows(image) :
    ...
    xy_window_list = [(64,64), (128,128), (256,256)] #(96,96),
    #x_start_stop_list = [[400, 500], [380, 500], [380, 600], [360, 700], [360, None]]
    y_start_stop_list = [[400, 540], [380, 650], [360, None]] #[380, 580],
    xy_overlap_list = []
...
def augmented_display(orignal_image, hit_windows) :
    ...
    filtered_heatmap = filter_heatmap(heatmap, threshold=1)
